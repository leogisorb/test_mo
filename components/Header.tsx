...
export function Header() {
  ...
  const scrollToSection = (id: string) => {
    ...
    if (id === 'gallery') {
      window.location.href = getNavPath('/gallery');
      setMobileMenuOpen(false);
      return;
    }
            ...
            {!isMainPage && (
              <li>
                <button
                  ...
                  className="text-text hover:text-primary transition-colors font-medium md:font-bold text-[17px] md:text-[15.4px] xl:text-[17.6px] flex items-center gap-2"
                >
                  <svg className="w-[17px] h-[17px] md:w-[17.6px] md:h-[17.6px] xl:w-[19.8px] xl:h-[19.8px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                  <span>{language === 'de' ? 'Home' : language === 'ru' ? 'Главная' : language === 'en' ? 'Home' : 'Accueil'}</span>
                </button>
              </li>
            )}
          ...
          <div className="flex items-center gap-2">
            <div className="relative" ref={languageDropdownRef}>
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 rounded border border-primary bg-transparent hover:bg-primary/5 text-primary text-[15px] md:text-[15.4px] xl:text-[17.6px] transition-colors"
              ...
              >
                ...
                <svg
                  className={`w-[17px] h-[17px] md:w-[17.6px] md:h-[17.6px] xl:w-[19.8px] xl:h-[19.8px] transition-transform text-primary ${
                  ...
                  {content.languages
                    ...
                    .map((lang) => (
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-4 py-2 text-[15px] md:text-[15.4px] xl:text-[17.6px] hover:bg-gray-100 transition-colors text-left"
                      >
